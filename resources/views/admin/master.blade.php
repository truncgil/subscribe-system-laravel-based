            ...
            <div class="content-header">
                ...
                <div class="content-header-section">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="btn btn-info d-none" onclick="window.print()"><i class="fa fa-print"></i> {{e2("Yazdır")}}</div>
                        <div class="btn btn-success d-none" onclick="ExportToExcel('xlsx')"><i class="fa fa-file-excel"></i> {{e2("Excel'e Aktar")}}</div>
                       <button type="button" class="btn btn-rounded btn-dual-secondary d-none" id="language-dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right min-width-200 d-none"
