...
<div class="block">
        ...
        <div class="block-content">
			...
			<?php // print_r( $permissions); ?>
						...
						<td>
							<a href="{{url('admin-ajax/password-update?id='.$u->id)}}" title="{{__('Kullanıcının şifresini sıfırla')}}" class="btn btn-default"><i class="fa fa-sync"></i> {{e2("Şifre Sıfırla")}}</button></td>
						<td>
							{{$u->recover}}	
